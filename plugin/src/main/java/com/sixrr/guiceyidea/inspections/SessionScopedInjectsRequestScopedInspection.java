...
@ExtensionImpl
public class SessionScopedInjectsRequestScopedInspection extends BaseInspection{
    ...
    private static class Visitor extends BaseInspectionVisitor{
        public void visitAnnotation(PsiAnnotation annotation){
            ...
            if(!AnnotationUtil.isAnnotated(containingClass, "com.google.inject.servlet.SessionScoped", true)){
                return;
            }
        ...
        private void checkForScopedInjection(PsiTypeElement typeElement){
            ...
            if(AnnotationUtil.isAnnotated(referencedClass, "com.google.inject.servlet.RequestScoped", true)){
            ...
            if(AnnotationUtil.isAnnotated(implementedByClass, "com.google.inject.servlet.RequestScoped", true)){
                registerError(typeElement);
            }
        }
    }
