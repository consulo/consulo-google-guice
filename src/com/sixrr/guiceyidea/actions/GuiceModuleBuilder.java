...
public class GuiceModuleBuilder{
    ...
    public String buildModuleClass() throws IOException{
        ...
        out.append(" extends com.google.inject.AbstractModule");
        out.append('\n');

        out.append('{');
        out.append("protected void configure(){\n");
        out.append("//add configuration logic here\n");
        out.append("}\n}\n");
        return out.toString();
    }
}