...
public class NewGuiceScopeAnnotationAction extends GeneratePluginClassAction{
    ...
    private static final Logger LOGGER = Logger.getInstance("NewGuiceScopeAnnotationAction");

    public NewGuiceScopeAnnotationAction(){
        super(GuiceyIDEABundle.message("new.guice.scope.annotation.action.name"),
                GuiceyIDEABundle.message("new.guice.scope.annotation.action.name"),
                null);
    }
    ...
    protected PsiElement[] create(String newName, PsiDirectory directory){
        ...
        final GuiceScopeAnnotationBuilder builder = new GuiceScopeAnnotationBuilder();
